...
(function (global) {
  ...
  CF.lang.fr = {
    ui: {
      ...
      "You have {$cash} and can borrow at most {$credit}, so paying this will sell whatever it has to.": "Vous avez {$cash} et pouvez emprunter au plus {$credit} : payer vendra donc ce qu’il faudra.",
