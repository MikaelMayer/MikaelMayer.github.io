...
(function (global) {
  ...
  CF.lang.fr = {
    ui: {
      ...
      "{$gap} of new income until you win": "{$gap} de nouveaux revenus avant la victoire",
      "You have added enough to win": "Vous avez ajouté assez pour gagner",
      "the {$goal} of new income you need": "les {$goal} de nouveaux revenus qu’il vous faut",
      "You have {$cash}, so this leaves you {$after}.": "Vous avez {$cash} : il vous restera {$after}.",
      "You have {$cash}, so paying this takes a loan of {$borrow}. That adds {$monthly} a month to your expenses until you repay it.": "Vous avez {$cash} : payer exige donc un emprunt de {$borrow}. Cela ajoute {$monthly} par mois à vos dépenses jusqu’au remboursement.",
      "You have {$cash} and can borrow no more, so paying this will sell investments. Selling everything you own would raise about {$raise}.": "Vous avez {$cash} et ne pouvez plus emprunter : payer vendra donc des investissements. Tout vendre rapporterait environ {$raise}.",
      "You have {$cash}, can borrow no more, and own nothing that can be sold. Paying this ends the game.": "Vous avez {$cash}, ne pouvez plus emprunter et ne possédez rien de vendable. Payer met fin à la partie.",
      "Privacy": "Confidentialité",
      "This game runs entirely in your browser. It makes no network requests, has no accounts, no analytics, no tracking and no cookies, and loads no fonts, scripts or images from any other site.": "Ce jeu fonctionne entièrement dans votre navigateur. Il n’effectue aucune requête réseau, n’a ni compte, ni mesure d’audience, ni traceur, ni cookie, et ne charge aucune police, aucun script ni aucune image depuis un autre site.",
      "Three things are kept on this device, and only on this device:": "Trois choses sont conservées sur cet appareil, et uniquement sur cet appareil :",
      "The game you are playing, saved as you go, so closing the tab does not lose it.": "La partie en cours, enregistrée au fur et à mesure, pour que fermer l’onglet ne la perde pas.",
      "Your language choice.": "Votre choix de langue.",
      "Which professions you have got out of the Rat Race with.": "Les professions avec lesquelles vous êtes sorti de la course des rats.",
      "None of it identifies you, and none of it is sent anywhere. Two things leave your browser only when you ask them to: Export writes a file where you choose to put it, and a share link carries the seed, profession and dream — nothing else.": "Rien de tout cela ne vous identifie et rien n’est envoyé où que ce soit. Deux choses quittent votre navigateur, et seulement si vous le demandez : Exporter écrit un fichier là où vous choisissez de le mettre, et un lien de partage contient la graine, la profession et le rêve — rien d’autre.",
      "The page itself is served by a web host, which like every web host records the IP addresses that request it. That happens before this game runs and is outside its control.": "La page elle-même est servie par un hébergeur, qui comme tout hébergeur enregistre les adresses IP qui la demandent. Cela se produit avant que ce jeu ne s’exécute et échappe à son contrôle.",
      "Delete everything stored on this device": "Supprimer tout ce qui est conservé sur cet appareil",
      "Yes, delete it all": "Oui, tout supprimer",
      "This deletes your saved game, your language choice and your stars. It cannot be undone.": "Cela supprime votre partie enregistrée, votre choix de langue et vos étoiles. C’est irréversible.",
      "Deleted. Nothing of this game is left on this device.": "Supprimé. Il ne reste rien de ce jeu sur cet appareil.",
      "Deleted": "Supprimé",
