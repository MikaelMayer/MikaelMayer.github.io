...
(function (global) {
  ...
  var SMALL_DEALS = [
    ...
    stock('sd01', 'HLTH', 5, 'A phase 3 trial collapsed in scandal and the regulator is investigating.'),
    stock('sd02', 'HLTH', 10, 'Two of its drugs failed review in the same quarter.'),
    stock('sd03', 'HLTH', 20, 'A quiet year. Nothing has been announced either way.'),
    stock('sd04', 'HLTH', 30, 'A new drug proved highly effective and is now on the market.'),
    stock('sd05', 'GRW', 5, 'Its founder resigned overnight and the accounts are being restated.'),
    stock('sd06', 'GRW', 15, 'Growth stalled and a third of the engineering team has left.'),
    stock('sd07', 'GRW', 30, 'It signed its largest customer to date.'),
    stock('sd08', 'GRW', 40, 'Its new product is the one everybody is talking about. The press calls it the company of the year.'),
    stock('sd09', 'BIGX', 10, 'A funding crisis forced it to close a third of its stores.'),
    stock('sd10', 'BIGX', 20, 'Sales are flat and an online rival is taking share.'),
    stock('sd11', 'BIGX', 40, 'Record holiday sales beat every forecast.'),
    stock('sd12', 'MYTV', 1, 'It lost the broadcasting rights the whole business was built on.'),
    stock('sd13', 'MYTV', 5, 'Advertising revenue has fallen for six quarters running.'),
    stock('sd14', 'MYTV', 15, 'Its new series is a hit and subscribers are pouring back.'),
    stock('sd15', 'NRGY', 5, 'A plant failure caused a spill and the fines are still being counted.'),
    stock('sd16', 'NRGY', 20, 'Energy prices have been steady all year.'),
    stock('sd17', 'NRGY', 35, 'It won a national contract that runs for a decade.'),
    stock('sd18', 'SAFE', 20, 'The regulator capped what it may charge households.'),
    stock('sd19', 'SAFE', 30, 'A regulated utility with a long dividend record. Nothing has changed this year.'),
    stock('sd20', 'SAFE', 40, 'It raised its dividend for the twelfth year running.'),
    stock('sd21', 'REIT', 20, 'Its biggest tenant went bankrupt and two buildings stand empty.'),
    stock('sd22', 'REIT', 25, 'A fund that owns apartment buildings. Occupancy is steady.'),
    stock('sd23', 'REIT', 35, 'Rents rose across every building and it is close to full.'),
