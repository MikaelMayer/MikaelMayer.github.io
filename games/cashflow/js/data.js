...
(function (global) {
  ...
  var SMALL_DEALS = [
    ...
    stock('sd01', 'HLTH', 5, 'A late-stage trial missed its target and the shares fell sharply.'),
    stock('sd02', 'HLTH', 10, 'A rival brought a similar treatment to market first.'),
    stock('sd03', 'HLTH', 20, 'Nothing much has happened this year; the shares sit mid-range.'),
    stock('sd04', 'HLTH', 30, 'A new treatment was approved and the press has been enthusiastic.'),
    stock('sd05', 'GRW', 5, 'A well-funded startup is undercutting it in its main market.'),
    stock('sd06', 'GRW', 15, 'Growth has slowed and two senior engineers have left.'),
    stock('sd07', 'GRW', 30, 'It has signed its largest corporate customer to date.'),
    stock('sd08', 'GRW', 40, 'Named company of the year in the business press. Trading volume is unusually high.'),
    stock('sd09', 'BIGX', 10, 'An online rival opened a warehouse beside its biggest store.'),
    stock('sd10', 'BIGX', 20, 'Sales are flat and it has closed four stores.'),
    stock('sd11', 'BIGX', 40, 'A strong holiday quarter beat every forecast.'),
    stock('sd12', 'MYTV', 1, 'It lost the broadcasting rights the business was built on. Penny stock, very high risk.'),
    stock('sd13', 'MYTV', 5, 'Advertising revenue has fallen for six quarters running.'),
    stock('sd14', 'MYTV', 15, 'A new streaming deal has brought subscribers back.'),
    stock('sd15', 'NRGY', 5, 'A project was cancelled and the regulator has opened an inquiry.'),
    stock('sd16', 'NRGY', 20, 'Energy prices have been steady all year.'),
    stock('sd17', 'NRGY', 35, 'It won a national contract and the press has praised its management.'),
    stock('sd18', 'SAFE', 20, 'The regulator has capped what it may charge households.'),
    stock('sd19', 'SAFE', 30, 'A regulated utility with a long dividend record. Nothing has changed this year.'),
    stock('sd20', 'SAFE', 40, 'It has raised its dividend for the twelfth year running.'),
    stock('sd21', 'REIT', 20, 'Several tenants have left and two buildings are half empty.'),
    stock('sd22', 'REIT', 25, 'A fund that owns apartment buildings. Occupancy is steady.'),
    stock('sd23', 'REIT', 35, 'Rents rose across its buildings and occupancy is close to full.'),
